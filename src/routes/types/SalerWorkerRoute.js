...
import { SALER_WORKER_ROLE, ROOT_PATH } from "../../utils/constants";

const SalerWorkerRoute = ({
  component: Component,
  authenticated,
  companyId,
  roles,
...
export default compose(connect(mapStateToProps))(withRouter(SalerWorkerRoute));
